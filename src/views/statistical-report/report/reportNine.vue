        ...
        <el-card class="box-card cardOne">
          <el-form :inline="true" :model="searchForm" class="demo-form-inline">
            <el-form-item label="查看用电结构：">
              <el-switch v-model="checked" on-text="" off-text=""></el-switch>
            </el-form-item>
    ...
    <el-row :gutter="20">
      ...
      <el-card class="box-card">
        ...
        <el-table :data="tableData.tableData" v-loading="loading" element-loading-text="数据获取中" border
          ...
          <el-table-column :prop="v.prop" :label="v.label" v-for="(v,k) in tableData.col" :key="k" fit
...
<script>
  import { getReportNine } from 'api/table'
  ...
  export default {
    ...
    methods: {
      ...
      search () {
        this.loading = true
        getReportNine(this.searchForm).then(res => {
